...
function Dashboard() {
    ...
    const getReport = async () => {
        try {
            const CalculateTotalOrderPrice = await axiosInstance.get("https://thecoffeeshopstore.azurewebsites.net/CalculateTotalOrderPrice");
            const CalculateTotalItems = await axiosInstance.get("https://thecoffeeshopstore.azurewebsites.net/CalculateTotalItems");
            const CountDrinks = await axiosInstance.get("https://thecoffeeshopstore.azurewebsites.net/CountDrinks");
            const GetMonthlyTotalPrices = await axiosInstance.get("https://thecoffeeshopstore.azurewebsites.net/GetMonthlyTotalPrices");
                    ...
                    <Card sx={{ maxWidth: 345 }}>
                        <CardContent>
                            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                                <div>
                                    <Typography gutterBottom variant="h5" component="div" color={"GrayText"}>
                                        Doanh thu
                                    </Typography>
                                    <Typography gutterBottom variant="h5" component="div">
                                        <b>{dataState?.tongDoanhThu?.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</b>
                                    </Typography>
                                </div>
                ...
                <div>
                    ...
                    >
                        <VictoryAxis
                            ...
                            tickFormat={["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"]}
                        />
                        <VictoryAxis
                            dependentAxis
